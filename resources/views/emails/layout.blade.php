...
<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;" data-gr-c-s-loaded="true">
<table class="wrapper"
       style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f5f5f5;"
            ...
            <div role="banner">
                <div class="header"
                    ...
                    <div class="logo emb-logo-margin-box"
                         style="font-size: 26px;line-height: 32px;Margin-top: 30px;Margin-bottom: 30px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;"
                         align="center">
                                    ...
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;"
                                        ...
                                        <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #f4645f;"
                                           href="#"><img
                                                ...
                                                alt="" width="160"
                                                src="{{ asset('angularbd/images/sponsor-'.$number.'.png') }}"></a>
                                    </div>
                                </div>
                            </div>
                            <!--[if (mso)|(IE)]></td>
