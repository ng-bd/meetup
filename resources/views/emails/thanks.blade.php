...
@section('content')
    <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
            ...
            <p style="Margin-top: 20px;Margin-bottom: 20px;">Congratulations, your seat has been confirmed for {{ env('EVENT_TITLE') }}. Thank you for joining in this event. Hopefully we'll pass a good time.</p>
        </div>
    </div>
