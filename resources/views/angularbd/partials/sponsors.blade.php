<div class="Meetup__sponsors" id="sponsors">
    ...
    <div class="Meetup__sponsorsWrapper">
        ...
        <a class="Meetup__sponsor" href="https://business.eskimi.com/" target="_blank"><img src="{{ asset('angularbd/images/sponsor-3@2x.png') }}" alt="sponsor"></a>
        <a class="Meetup__sponsor" href="https://www.techmastersbd.com/" target="_blank"><img src="{{ asset('angularbd/images/sponsor-4@2x.png') }}" alt="sponsor"></a>
        ...
        <a class="Meetup__sponsor" href="https://thesoftking.com/" target="_blank"><img src="{{ asset('angularbd/images/sponsor-6@2x.png') }}" alt="sponsor"></a>
        <a class="Meetup__sponsor" href="https://jouleslabs.com/" target="_blank"><img src="{{ asset('angularbd/images/sponsor-7@2x.png') }}" alt="sponsor"></a>
    </div>
