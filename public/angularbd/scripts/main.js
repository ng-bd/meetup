...
(function () {
  ...
  var Impetus = function Impetus(elem, cfg) {
    ...
    var on = function on(elem, event, fn) {
    ...
    var addTrackingPoint = function addTrackingPoint(x, y, time) {
    ...
    var startDecelAnim = function startDecelAnim() {
    ...
    var stepDecelAnim = function stepDecelAnim() {
  ...
  function horizontalScroll() {
    ...
    if (typeof scrolls != 'undefined' && scrolls != null && scrolls.length > 0) {
      Array.prototype.forEach.call(scrolls, function (scroll) {
        var maxScroll = scroll.scrollWidth - scroll.offsetWidth; // console.log(scroll.offsetWidth)
  ...
  horizontalScroll(); // Let's listen for the resize event
...
(function () {
  'use strict'; // var scroll = new SmoothScroll('a[href*="#"]');
